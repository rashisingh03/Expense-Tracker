...
public class TransactionsAdapter extends RecyclerView.Adapter<TransactionsAdapter.TransactionViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TransactionViewHolder holder, int position) {
        ...
        // SHOW THE NOTE ONLY IN NOTES TAB
        if (Constants.SELECTED_TAB == Constants.NOTES) {
            if (transaction.getNote() != null && !transaction.getNote().isEmpty()) {
                holder.binding.msg.setText(transaction.getNote());
                holder.binding.msg.setVisibility(View.VISIBLE);
            } else {
                holder.binding.msg.setVisibility(View.GONE);
            }
        } else {
            holder.binding.msg.setVisibility(View.GONE);
        }
